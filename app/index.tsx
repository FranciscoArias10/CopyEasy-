...
export default function HomeScreen() {
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
            ...
            <Text style={[styles.subtitle, { color: '#00E5FF', fontWeight: '600' }]}>
            ...
            <View style={styles.actionsContainer}>
                ...
                >
                    ...
                    <View style={styles.cardContent}>
                        ...
                        <Text style={[styles.cardDescription, { color: '#00E5FF', fontWeight: '600' }]}>
                ...
                {Platform.OS === 'web' && (
                    <TouchableOpacity
                        ...
                        onPress={() => Linking.openURL('https://github.com/FranciscoArias10/CopyEasy-/releases/download/v1.0.0/copyeasy.apk')} // GitHub Releases Direct Download
                        activeOpacity={0.8}
                    >
